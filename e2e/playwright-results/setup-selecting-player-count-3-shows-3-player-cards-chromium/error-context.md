...
- Name: setup.spec.js >> selecting player count 3 shows 3 player cards
- Location: e2e/tests/setup.spec.js:14:1
...
Call log:
  - waiting for locator('.count-buttons .action-btn').filter({ hasText: '3' })
