...
- Name: classic-game.spec.js >> "Play Again" on win banner navigates back to setup
- Location: e2e/tests/classic-game.spec.js:54:1
...
Call log:
  - waiting for locator('.action-btn.btn-success').filter({ hasText: 'Start Game' })
