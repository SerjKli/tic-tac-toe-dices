export default {
  ...
  cards: {
    ...
    skipTurn: { name: 'Пропуск хода', desc: 'Выберите игрока, который пропустит следующий ход', receivedDesc: 'Вы пропускаете свой следующий ход!' },
    ...
    shake: { name: 'Встряска', desc: 'Перемешайте все фишки случайно' }
  },
  home: {
